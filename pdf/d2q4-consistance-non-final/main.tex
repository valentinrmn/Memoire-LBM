...
\begin{multline*}
s_1^2s_2 \Delta t \partial_t u =\frac{\Delta x^2}{2} s_2(s_1^2-2s_1) \Delta u + \frac{\Delta t^2}{2}\left( 2s_1^2 + s_1^2 s_2 + 4s_1s_2 \right) + \frac{\Delta x^4}{48} s_2(s_1^2-2s_1) (\partial_{xxxx}u + \partial_{yyyy} u) + \\
